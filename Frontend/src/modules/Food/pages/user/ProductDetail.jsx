      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12">
        ...
        <div className="relative w-full h-[350px] sm:h-[400px] md:h-[450px] lg:h-[500px] xl:h-[550px] overflow-hidden rounded-lg md:rounded-xl lg:rounded-2xl mt-4 md:mt-6 lg:mt-8">
          ...
          <div className="absolute top-4 right-4 z-10">
            <Badge className="bg-[#FE5502] text-white shadow-lg">
          ...
          <ScrollReveal>
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-2 text-xs sm:text-sm text-muted-foreground flex-wrap">
                <Link to="/user" className="hover:text-[#FE5502] transition-colors">Home</Link>
                <span>/</span>
            ...
            <div className="space-y-4 pb-4 border-b">
              ...
              {inCart ? (
                <div className="flex items-center gap-4">
                  <div className="flex items-center gap-2 border border-[#FE5502] rounded-lg">
                    <Button
                      variant="ghost"
                      size="icon"
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-lg font-bold text-[#FE5502]">
                ...
                <div className="flex items-center gap-4">
                  ...
                  >
                    <Button
                      ...
                      className="bg-[#FE5502] hover:opacity-90 text-white"
                    >
            ...
            <ScrollReveal delay={0.1}>
              <div className="space-y-3 md:space-y-4 pb-4 md:pb-6 border-b">
                <div className="flex items-center justify-between">
                  ...
                  <Badge className="bg-[#FE5502] text-white text-sm md:text-base">{restaurant.priceRange}</Badge>
                </div>
                ...
                <div className="space-y-4 pb-4 border-b">
                  ...
                  <form onSubmit={handleSubmitReview} className="space-y-4">
                    ...
                    <div className="flex gap-2">
                      ...
                      <Button
                        type="submit"
                        className="flex-1 bg-gradient-to-r bg-[#FE5502] hover:from-red-600 hover:to-red-600"
                      >
