            ...
            <div className="flex gap-2.5 mb-6">
              {socialLinks.map((social) => (
                <a 
                  ...
                  className="bg-black text-white rounded-full hover:bg-gray-800 transition-colors flex items-center justify-center w-7 h-7"
                  aria-label={social.name}
                >
                  <social.icon size={16} strokeWidth={2} className="text-white" />
                </a>
              ))}
            </div>
