...
const colorOptions = [
  ...
  { value: 'text-primary dark:text-orange-400', label: 'Blue', bg: 'bg-orange-100 dark:bg-orange-900/30' },
  ...
  { value: 'text-primary dark:text-orange-400', label: 'Purple', bg: 'bg-orange-100 dark:bg-orange-900/30' },
