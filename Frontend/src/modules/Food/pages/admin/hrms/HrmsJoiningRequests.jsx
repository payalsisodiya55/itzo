...
import {
    ...
    MessageSquare, ChevronLeft, ChevronRight, Clock, Filter, X
} from 'lucide-react';
    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    <h1 className="text-2xl font-bold text-slate-900">Joining Requests</h1>
                    <p className="text-sm text-slate-500 mt-1">Review and manage employee applications</p>
                </div>
            </div>
